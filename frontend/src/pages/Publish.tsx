    ...
    return <form>
       <div className="w-full mb-4">
           ...
           <div className="px-4 py-2 bg-white rounded-b-lg w-full">
               ...
               <textarea onChange={onChange} id="editor" rows={8} className="focus:outline-none pl-2 block w-full px-0 text-sm text-gray-800 bg-white border-0 focus:ring-0 rounded" placeholder="Write an article..." required ></textarea>
           </div>
           </div>
       </div>
    </form>
